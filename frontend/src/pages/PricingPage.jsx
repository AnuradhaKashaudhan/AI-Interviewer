...
const plans = [
  {
    ...
    features: ['3 mock interview sessions', 'Basic ATS checker', 'Standard feedback report'],
    cta: 'Choose Free',
  },
  {
    id: 'pro',
    name: 'Pro Technical Pack',
    price: '₹19',
  ...
  },
  {
    ...
    features: [
      'All Pro Technical Pack features',
      'AI Career Intelligence Agent audit',
      'Personalized explainable gap analysis',
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="overflow-hidden rounded-[28px] border border-stone-200 bg-white">
        ...
        {[
          ['Mock interviews', '3 sessions', 'Unlimited', 'Unlimited'],
          ['ATS checker', 'Basic', 'Advanced Fix-It', 'Advanced Fix-It'],
